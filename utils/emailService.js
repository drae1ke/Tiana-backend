...
const lowStockEmailTemplate = (products) => {
  ...
  return {
    subject: `⚠️ Low Stock Alert – ${products.length} item(s) need restocking`,
    html: `
      <div style="font-family:Arial,sans-serif;max-width:700px;margin:0 auto;background:#f9f9f9;padding:20px;border-radius:8px">
        <div style="background:#0B7B44;padding:20px;border-radius:8px 8px 0 0;text-align:center">
          <h1 style="color:white;margin:0;font-size:22px">🌿 Agrovet POS – Low Stock Alert</h1>
        </div>
        <div style="background:white;padding:24px;border-radius:0 0 8px 8px">
          ...
          <p style="color:#999;font-size:12px;margin-top:32px;border-top:1px solid #eee;padding-top:16px">
            This is an automated notification from Agrovet POS. Generated at ${new Date().toLocaleString()}.
          </p>
        </div>
      </div>`,
  };
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:700px;margin:0 auto;background:#f9f9f9;padding:20px;border-radius:8px">
        <div style="background:#c05621;padding:20px;border-radius:8px 8px 0 0;text-align:center">
          <h1 style="color:white;margin:0;font-size:22px">⏰ Agrovet POS – Expiry Warning</h1>
        </div>
        <div style="background:white;padding:24px;border-radius:0 0 8px 8px">
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:700px;margin:0 auto;background:#f9f9f9;padding:20px;border-radius:8px">
        <div style="background:#2b6cb0;padding:20px;border-radius:8px 8px 0 0;text-align:center">
          <h1 style="color:white;margin:0;font-size:22px">📦 Agrovet POS – Purchase Order</h1>
        ...
        <div style="background:white;padding:24px;border-radius:0 0 8px 8px">
          ...
          <div style="margin-top:20px;padding:16px;background:#ebf8ff;border-left:4px solid #2b6cb0;border-radius:4px">
            This order was automatically generated by Agrovet POS due to low stock levels. Please confirm or contact us to adjust quantities.
          </div>
          <p style="color:#999;font-size:12px;margin-top:32px;border-top:1px solid #eee;padding-top:16px">
            Agrovet POS – ${new Date().toLocaleString()}
          </p>
        </div>
      </div>`,
  };
